...
class SlugContentView extends StatelessWidget {
   String slugValue;
   SlugContentView({Key key, String this.slugValue}) : super(key: key);

  Future<String> _getConetnt() async {
    var api = Api(baseUrl: Config.apiBaseUrl);
    var response = await api.slugContent(this.slugValue);
